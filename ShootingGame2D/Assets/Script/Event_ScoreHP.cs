...
public class Event_ScoreHP : MonoBehaviour {
    ...
    private void GameOverCheck()
    {
        if (Player_Data.HP <= 0)
        {
            ...
            Player.transform.Find("Main Camera").Find("GameOverCanvas").GetComponent<GameOver_Menu>().GameOverType = 0;
        ...
        else if(BossDeathCheck)
        {
            ...
            Player.transform.Find("Main Camera").Find("GameOverCanvas").GetComponent<GameOver_Menu>().GameOverType = 1;
